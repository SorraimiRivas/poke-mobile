import { TypeColorData } from "../types/pokemon-types";
...
// 		if (!heights.includes(HEIGHT_OPTIONS.short))
// 			filter._gte = HEIGHT_RANGES.medium.min;
// 	}

// 	if (heights.includes(HEIGHT_OPTIONS.tall)) {
// 		filter._lte = HEIGHT_RANGES.tall.max;
// 		if (
// 			!heights.includes(HEIGHT_OPTIONS.short) &&
// 			!heights.includes(HEIGHT_OPTIONS.medium)
// 		)
...
// 		if (!weights.includes(WEIGHT_OPTIONS.light))
// 			filter._gte = WEIGHT_RANGES.medium.min;
// 	}

// 	if (weights.includes(WEIGHT_OPTIONS.heavy)) {
// 		filter._lte = WEIGHT_RANGES.heavy.max;
// 		if (
// 			!weights.includes(WEIGHT_OPTIONS.light) &&
// 			!weights.includes(WEIGHT_OPTIONS.medium)
// 		)
